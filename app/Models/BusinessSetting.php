...
class BusinessSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'is_order_creadit_diduct_manual',
    ...
    public function getBusinessSettingObject(): array
    {
        $data = [
            ...
            'is_order_creadit_diduct_manual' => $this->is_order_creadit_diduct_manual == '1' ? true : false,
            'deduct_credit_per_customer_order' => $this->deduct_credit_per_customer_order,
