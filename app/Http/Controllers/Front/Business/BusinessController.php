...
class BusinessController extends Controller
{
    ...
    public function template1(Request $request, $business)
    {
        ...
        $details['products'] = [];
        $details['categoriesWithProducts'] = [];
        ...
        return ['view' => 'front.business.template1.businessHome', 'data' => compact('business', 'setting', 'departments', 'experts', 'banners', 'details', 'galleries', 'totalExperts')];
