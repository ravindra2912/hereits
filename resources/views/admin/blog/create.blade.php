                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="meta_title" placeholder="SEO optimized title" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-2">
                                        <label class="form-label small">Meta Description</label>
                                        <textarea class="form-control form-control-sm" name="meta_description" placeholder="Short summary for search results" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label small">Meta Keywords</label>
                                        <input type="text" class="form-control form-control-sm" name="meta_keywords" placeholder="keyword1, keyword2, keyword3" />
                                    </div>
                                </div>
                            </div>
                        </div>
