          ...
          <form action="{{ route('admin.faq.update', $faq->id) }}" data-action="redirect" class="row formaction">
            ...
            <div class="col-md-12 mb-3">
              ...
              <select class="form-select" name="type" required>
                ...
                <option value="Business" {{ $faq->type == 'Business' ? 'selected' : '' }}>Business</option>
                <option value="Appointment" {{ $faq->type == 'Appointment' ? 'selected' : '' }}>Appointment</option>
                <option value="Services" {{ $faq->type == 'Services' ? 'selected' : '' }}>Services</option>
