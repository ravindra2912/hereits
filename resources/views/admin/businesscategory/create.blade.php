          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="number" class="form-control required" name="deduct_credit_per_chat" value="1" min="0" step="0.01" placeholder="e.g. 1.00" />
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="number" class="form-control required" name="deduct_credit_per_quotation" value="1" min="0" step="0.01" placeholder="e.g. 1.00" />
              </div>
            </div>
          </div>
        </div>
