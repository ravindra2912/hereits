      ...
      <div class="row g-4 mb-4">
        ...
        <div class="col-md-4">
          <div class="text-center mb-4">
            <div class="avtar">
              <img onerror="this.src='{{ getImage(null) }}'" src="{{ getImage('') }}" class="avtar_img" alt="User Avatar" loading="lazy" />
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="date" class="form-control" name="dob" placeholder="Date of Birth" max="{{ date('Y-m-d') }}" />
              </div>
            </div>
