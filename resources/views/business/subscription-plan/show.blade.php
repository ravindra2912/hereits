...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('business.subscription') }}" class="text-decoration-none">Subscription</a></li>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-5 bg-primary bg-gradient text-white p-5 d-flex flex-column justify-content-center text-center">
                    ...
                    <h1 class="display-3 fw-bold mb-3">
                        <span class="fs-2 align-top">₹</span>{{ number_format($plan->price, 0) }}
                    </h1>
                    <p class="fs-5 opacity-75 mb-4">{{ $plan->duration }} {{ $plan->duration > 1 ? 'Months' : 'Month' }} Subscription</p>
                ...
                <div class="col-md-7 p-5 bg-white">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                            <span class="text-dark fw-medium">{{ $plan->name }} Plan</span>
                            <span class="text-dark fw-bold">₹{{ number_format($plan->price, 2) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="order-summary mb-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            ...
                            <span class="fs-4 fw-bold text-primary">₹<span id="total_amount">{{ number_format($plan->price, 2) }}</span></span>
                        </div>
                    </div>
...
<form id="purchaseForm" method="POST" action="{{ route('business.subscription.buy') }}" class="d-none">
    @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#apply_coupon').click(function() {
            ...
            $.ajax({
                url: "{{ route('business.subscription.validate_coupon') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    coupon_code: code,
