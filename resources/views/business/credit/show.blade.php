...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('business.credits') }}" class="text-decoration-none">Credits</a></li>
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="row g-0">
                ...
                <div class="col-md-5 bg-primary bg-gradient text-white p-5 d-flex flex-column justify-content-center text-center">
                    <div class="mb-4">
                        <span class="badge bg-white text-primary fw-bold text-uppercase py-2 px-3 rounded-pill shadow-sm">Credits Purchase</span>
                    </div>
                    @php
                    ...
                    <p class="fs-5 opacity-75 mb-4">{{ $quantity }} Credits</p>
                    ...
                    <div class="text-start mt-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2 d-flex align-items-center">
                                ...
                                <span>Accept Online Appointments</span>
                            </li>
                            <li class="mb-2 d-flex align-items-center">
                                <i class="bi bi-check-circle-fill me-2"></i>
                ...
                <!-- Checkout Form -->
                <div class="col-md-7 p-5 bg-white" id="checkout-form-container">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
                            <span class="text-dark fw-medium">Credits (Qty: {{ $quantity }})</span>
                    ...
                    <div class="order-summary mb-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            ...
                            <span class="fs-4 fw-bold text-primary">₹<span id="total_amount">{{ number_format($total_price, 2) }}</span></span>
                        </div>
                    </div>
...
<form id="purchaseForm" method="POST" action="{{ route('business.credits.buy') }}" class="d-none">
    @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#apply_coupon').click(function() {
            ...
            $.ajax({
                url: "{{ route('business.credits.validate_coupon') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    coupon_code: code,
        ...
        function resetCoupon(msg) {
            ...
            $('#total_amount').text(parseFloat(originalPrice).toFixed(2));
        ...
        $('#pay_now_btn').click(function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('business.credits.buy') }}",
                        type: "POST",
                        data: formData,
                        success: function(response) {
                            if (response.success) {
