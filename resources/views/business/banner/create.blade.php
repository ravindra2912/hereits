...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form id="banner-form" class="formaction" action="{{ route('business.banner.store') }}" method="POST" enctype="multipart/form-data" data-action="redirect">
                    @csrf
                    <div class="mb-3">
                        ...
                        <div class="form-text">Recommended size: 1200x400px. Max size: 2MB.</div>
                        <div id="image-preview" class="mt-2 img-hide">
                            <img src="" class="img-fluid rounded border" style="max-height: 200px;" loading="lazy">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary btn_action">
                            ...
                            <span id="buttonText">Save Banner</span>
                        </button>
                    </div>
                </form>
            </div>
        ...
        $('#image').change(function() {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    $('#image-preview').removeClass('img-hide');
                }
