...
<div class="row">
  <div class="col-md-12">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form action="{{ route('business.appointment.department.store') }}" data-action="redirect" class="formaction" method="POST">
          @csrf
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
...
@push('js')
<script>
  // Script preserved if needed for future extensions, though simpler now.
</script>
@endpush