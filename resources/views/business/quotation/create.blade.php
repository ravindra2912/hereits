...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="m-0 fw-bold text-dark"><i class="bi bi-file-earmark-plus me-2 text-primary"></i>Create Quotation</h4>
                            ...
                            <table class="table table-sm table-borderless text-end align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="px-3" style="width: 150px;">
                                        <input type="number" name="discount" id="summary_discount" class="form-control form-control-sm text-end rounded-pill" value="0.00" min="0" step="0.01">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-secondary align-middle">Shipping Charge (₹):</td>
                                    <td class="px-3">
                                        <input type="number" name="shipping_charge" id="summary_shipping" class="form-control form-control-sm text-end rounded-pill" value="0.00" min="0" step="0.01">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-secondary align-middle">Tax (₹):</td>
                                    <td class="px-3">
                                        <input type="number" name="tax" id="summary_tax" class="form-control form-control-sm text-end rounded-pill" value="0.00" min="0" step="0.01">
                                    </td>
                                </tr>
