...
<div class="row g-4 mb-5">
            ...
            <div class="card-body p-4 d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="d-flex align-items-baseline">
                        <h3 class="mb-0 fw-bold text-dark">{{ $businessSettings->product_limit }}</h3>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden text-start">
            <div class="card-body p-4 d-flex align-items-center">
                @php
                $isActive = $businessSettings->product_limit_expiry_date && \Carbon\Carbon::parse($businessSettings->product_limit_expiry_date)->isFuture();
                @endphp
            ...
            <div class="card-body p-4 d-flex align-items-center">
                ...
                <div>
                    ...
                    <h4 class="mb-0 fw-bold text-dark">
                        {{ $businessSettings->product_limit_expiry_date ? get_date($businessSettings->product_limit_expiry_date) : 'N/A' }}
                    </h4>
                </div>
            </div>
        </div>
...
<script>
    $(function() {
        ...
        $('.buy-details-btn').click(function(e) {
            ...
            var url = "{{ route('business.product.plan.details', ':id') }}";
