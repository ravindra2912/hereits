...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <form id="service-form" class="formaction" action="{{ route('business.service.store') }}" method="POST" enctype="multipart/form-data" data-action="redirect">
            @csrf
            <div class="row g-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-grid">
                                    <button type="button" class="btn btn-outline-primary mb-2" onclick="$('#image').click()">
                                        <i class="bi bi-cloud-upload me-2"></i>Choose Service Image
                                    </button>
                                </div>
                                <input type="file" class="img-hide required" id="image" name="image" accept="image/*">
                                <div class="form-text mt-2 small text-center">Recommended: 800x600px, Max 2MB.</div>
                            </div>
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg required" id="name" name="name" placeholder="E.g. Full Body Massage">
                            </div>

                            <div class="mb-4">
                                <label for="description" class="form-label">Service Description</label>
                                <textarea class="form-control" id="description" name="description" rows="4" placeholder="Describe the service in detail..."></textarea>
                            </div>
                            ...
                            <div class="bg-light p-3 rounded-3 border">
                                ...
                                <div id="fixed-price-container" class="mb-0">
                                    <label for="price" class="form-label">Price <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white">₹</span>
                                        <input type="number" class="form-control required" id="price" name="price" step="0.01" placeholder="0.00">
                                    </div>
                                </div>

                                <div id="range-price-container" class="row g-3 d-none">
                                    <div class="col-md-6 text-center">
                                        <label for="min_price" class="form-label">Minimum Price <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-white">₹</span>
                                            <input type="number" class="form-control required" id="min_price" name="min_price" step="0.01" placeholder="0.00">
                                        </div>
                                    </div>
                                    <div class="col-md-6 text-center">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-white">₹</span>
                                            <input type="number" class="form-control required" id="max_price" name="max_price" step="0.01" placeholder="0.00">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-white py-3 text-end">
                            ...
                            <button type="submit" class="btn btn-primary px-5 btn_action">
                                ...
                                <span id="buttonText">Save Service</span>
                            </button>
                        </div>
                    </div>
                </div>
