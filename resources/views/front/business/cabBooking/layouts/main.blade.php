...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/front/cabBooking/cabBooking.css') }}?v={{ filemtime(public_path('assets/front/cabBooking/cabBooking.css')) }}">
...
<body class="business-details-layout">
    ...
    <!-- Navbar -->
    @include('front.business.cabBooking.layouts.header')
    ...
    <!-- Footer -->
    @include('front.business.cabBooking.layouts.footer')
    ...
    @include('front.business.cabBooking.layouts.mobile_footer')
    ...
    <script src="{{ asset('assets/front/cabBooking/cabBooking.js') }}?v={{ filemtime(public_path('assets/front/cabBooking/cabBooking.js')) }}"></script>


    <!-- Auth Modals -->
    @include('front.business.cabBooking.layouts.auth_modals')

    <!-- Share Modal -->
    @include('front.business.cabBooking.layouts.share_modal')
